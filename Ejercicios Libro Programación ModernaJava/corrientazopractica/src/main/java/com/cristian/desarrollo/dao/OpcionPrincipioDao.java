...
public class OpcionPrincipioDao {
    public List<OpcionPrincipio> listar() throws SQLException{
        ...
        try {
            ...
            String sql = "SELECT * FROM OpcionPrincipio";
            ...
            while(rset.next()){
                OpcionPrincipio principio = new OpcionPrincipio(rset.getString("nombre"));
    ...
    public void guardar(OpcionPrincipio principio) throws SQLException{
        ...
        try {
            ...
            // Crear sentencia preparada
            String sql = "INSERT INTO OpcionPrincipio (id, nombre) VALUES (?,?)";
            pstmt = connection.prepareStatement(sql);
            
            pstmt.setInt(1, generarConsecutivo());
            pstmt.setString(2, principio.getNombre());
    ...
    private int generarConsecutivo() throws SQLException{
        ...
        try {
            ...
            connection = JDBCUtilities.getConnection();
            // Crear sentencia preparada
            String sql = "SELECT MAX(id) AS ID FROM OpcionPrincipio;";
            pstmt = connection.prepareStatement(sql);
